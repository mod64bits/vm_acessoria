    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validade', models.DateField(default=datetime.date(2023, 2, 9), verbose_name='Validade')),
                ...
                ('codigo', models.CharField(default='2023-01-Y45nN', editable=False, max_length=20, unique=True, verbose_name='Codigo')),
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='empresa_orcamento', to='empresas.empresa', verbose_name='Empresa para o Orçamento')),
            ],
        ),
        migrations.CreateModel(
            name='ItemProduto',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('modified', models.DateTimeField(auto_now=True, verbose_name='Modificado em')),
                ('mao_de_obra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item_mao_obra', to='servicos.maodeobra', verbose_name='Mão de Obra')),
